...
func (cl *Client) GetQuoteWithResponse(ctx context.Context, params *GetQuoteParams, reqEditors ...RequestEditorFunction) (*GetQuoteResponse, error){
...
func (cl *Client) GetQuote(ctx context.Context, params *GetQuoteParams, reqEditors ...RequestEditorFunction) (*http.Response, error){
  req, err := NewQuoteRequest(cl.EndpointURL, params)
  if err != nil{
    return nil, err
  }
